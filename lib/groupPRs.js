...
const handlePRGroups = (allPRsCreated, allPRComments) => {
    const finalPRs = {
    ...
    allPRsCreated.forEach(repoGroup => {
        ...
        if (type === shared_types_1.QueryType['pr-created'] && ((_a = data[0]) === null || _a === void 0 ? void 0 : _a.repo)) {
        ...
        if (type === shared_types_1.QueryType['commit']) {
