...
const handleInputAndAggregate = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const handleSingleUserCallback = (currentIndex) => (0, handleSingleUser_1.default)(inputFields, usernames[currentIndex], startDate);
    (0, shared_1.performWithDelay)(handleSingleUserCallback, 0, usernames.length);
});
